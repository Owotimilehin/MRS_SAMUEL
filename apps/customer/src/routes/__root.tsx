...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Mrs. Samuel Juice Delight is a vibrant, single-page website showcasing premium Nigerian cold-pressed juices." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Mrs. Samuel Juice Delight is a vibrant, single-page website showcasing premium Nigerian cold-pressed juices." },
