/**
 * Lightweight client-side error reporting. See apps/customer/src/lib/telemetry.ts
 * for the rationale; duplicated here to keep frontend apps self-contained.
 */
...
const ENDPOINT = "/v1/telemetry/error";
